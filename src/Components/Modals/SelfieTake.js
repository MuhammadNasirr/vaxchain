      ...
      <View style={styles.modalBackGround}>
        ...
        <View style={{ width: '90%', backgroundColor: '#ffff', borderRadius: 20, paddingBottom: 30, paddingTop: 10 }}>
          ...
          <View style={{ width: '100%', alignItems: 'center' }}>
            ...
            <Text style={{fontFamily:'Rubik-Bold', marginVertical: 10, fontSize: 24, textAlign: 'center',  color: '#F5914E', width: '70%' }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'flex-start', width: '90%', marginVertical: 20 }}>
              ...
              <Text style={{fontFamily:'Poppins-Regular', marginLeft: 10 ,color:'#A2A2A2' }}>Please present the QR Code for your 2nd dose with the following schedule</Text>
            </View>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'flex-start', width: '90%', marginVertical: 5 }}>
              <Icon type={"entypo"} name={"dot-single"} color={"#000"} size={30} />
              <Text style={{ fontFamily:'Poppins-Regular',marginLeft: 10 ,color:'#A2A2A2'}}>Use your original ID. (Not a photocopy or scanned version)</Text>
            </View>
            <View style={{ flexDirection: 'row', alignItems: 'flex-start', width: '90%', marginVertical: 5 }}>
              <Icon type={"entypo"} name={"dot-single"} color={"#000"} size={30} />
              <Text style={{fontFamily:'Poppins-Regular', marginLeft: 10,color:'#A2A2A2' }}>ID details should be the same with your profile</Text>
            </View>
            <View style={{ flexDirection: 'row', alignItems: 'flex-start', width: '90%', marginVertical: 5 }}>
              <Icon type={"entypo"} name={"dot-single"} color={"#000"} size={30} />
              <Text style={{fontFamily:'Poppins-Regular', marginLeft: 10,color:'#A2A2A2' }}>Wait for 4 corners to light up when taking photo</Text>
            </View>
            <View style={{ flexDirection: 'row', alignItems: 'flex-start', width: '90%', marginVertical: 5 }}>
              <Icon type={"entypo"} name={"dot-single"} color={"#000"} size={30} />
              <Text style={{fontFamily:'Poppins-Regular', marginLeft: 10,color:'#A2A2A2' }}>Place behind a dark background</Text>
            </View>
            <TouchableOpacity
              onPress={() => {
                onClose()
              ...
              <Text style={{ fontFamily:'Poppins-Bold',color: '#ffff',  fontSize: 16, textTransform: 'uppercase' }}>{"GOT IT"}</Text>
            </TouchableOpacity>
          </View>
        </View>
