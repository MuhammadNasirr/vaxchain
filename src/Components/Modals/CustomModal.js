      ...
      <View style={styles.modalBackGround}>
        ...
        <View style={{ width: '80%', backgroundColor: '#ffff', borderRadius: 20, paddingBottom: 30, paddingTop: 10 }}>
          ...
          <View style={{ width: '100%', alignItems: 'center' }}>
            {icon}
            <Text style={{fontFamily:'Poppins-Bold', marginVertical: 10, fontSize: 18, textAlign: 'center',  color: '#F5914E', width: '80%' }}>
              {mainText}
            </Text>
            <Text style={{fontFamily:'Poppins-Regular', textAlign: 'center', width: '80%',color:'#8c8c8c' }}>{descriptionText}</Text>
            {
              isButton &&
              <TouchableOpacity onPress={buttonPress} style={{ backgroundColor: '#F5914E', width: '80%', alignSelf: 'center', alignItems: 'center', paddingVertical: 12, borderRadius: 15, marginTop: 20 }}>
                <Text style={{fontFamily:'Poppins-Bold', color: '#ffff',  fontSize: 16, textTransform: 'uppercase' }}>{buttonText}</Text>
              </TouchableOpacity>
            }
          </View>
        </View>
