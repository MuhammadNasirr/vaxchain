...
export default function ScanDocument({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{fontFamily:'Poppins-Regular', backgroundColor: '#727272', height: '70%', width: '100%', justifyContent: 'center', alignItems: 'center' }}>
      ...
      <View style={{fontFamily:'Poppins-Regular', paddingVertical: 20, backgroundColor: "#ffff", width: '100%' }}>

        <Text style={{fontFamily:'Poppins-Regular', color: "#F79150", alignSelf: "center", fontSize: 16, fontWeight: 'bold', marginBottom: 10 }}>Scan Document</Text>
