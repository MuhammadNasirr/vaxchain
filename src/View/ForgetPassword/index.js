    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={{ width: '100%', alignItems: 'center', marginLeft: 30, marginTop: 40 }}>
                ...
                <Text style={{fontFamily:'Poppins-Regular', fontFamily:'Poppins-Regular',alignSelf: 'flex-start', textAlign: 'justify', marginTop: 10, color: 'grey', fontWeight: '100' }}> No Worries. Enter Your registered email. and {'\n'} we will send you password recovery {'\n'} instructions.</Text>
            ...
            color='black' keyboardType='email-address' placeholder="Email Address" style={{fontFamily:'Poppins-Regular', backgroundColor: '#F3F3F3', width: '80%', paddingVertical: 15, paddingHorizontal: 10, borderRadius: 10 }} />
                ...
                >
                    <Text style={{fontFamily:'Poppins-Regular', fontWeight: 'bold', color: '#ffff' }}>sent reset Email</Text>
                </TouchableOpacity>
